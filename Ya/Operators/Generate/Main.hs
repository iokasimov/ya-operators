...
variate :: Unit `AR` Variance `AR___` Scrolling List `T'I` Unit `AR_` Scrolling List `T'I` Variated Unit
...
initial = wrap [Unit] `lu` wrap [Unit] `lu` intro @Tree `ha` Record (by Co) `ha` intro @(Nonempty List) `hv` by E
